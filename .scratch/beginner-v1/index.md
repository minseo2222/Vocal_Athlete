...
| 25 | A1 F0 검출 + MicPitchSource + RecordingPitchSource(실 마이크) ✅ (기기 관찰만 남음) | AFK | 14, 21 |
| 26 | C3 변주 엔진 ✅ | AFK | 17 |
| 27 | 홈 화면(경고→홈→레슨) ✅ MVP | AFK | 18 |
| 28 | Progression 영속화(shared_preferences) ✅ MVP | AFK | — |
| 29 | 실 캘린더 바인딩(dev 다음날 제거) ✅ MVP | AFK | 28 |
| 30 | 설정 화면 ✅ MVP | AFK | 27 |
| 31 | 실 마이크 frame 어댑터(RecordingPitchSource) ✅ 코드 완료 (flutter run 기기 관찰 권장) | AFK | 25 |
| 32 | F0 검출 spike/ 밖 승격 ✅ | AFK | 25 |
| 33 | 오늘 완료→홈 복귀+완료 상태 ✅ | AFK | 27 |
| 34 | 마이크 권한 거부 인라인 안내 ✅ | AFK | 25 |
| 35 | 장르 변경 재진입점 ✅ | AFK | 24 |
| 36 | 실행 경고 마이크 하강 애니메이션+로고 ✅ | AFK | 03 |
